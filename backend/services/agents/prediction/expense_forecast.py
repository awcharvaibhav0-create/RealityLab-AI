...
class ExpenseForecaster:
    def forecast(
        ...
        initial_expense = input_data.historical_data.get("expense", 0.0)
        values = growth_model.calculate_growth(
            initial_expense, input_data.time_horizon_months
        )
        time_points = [
        ...
        return ForecastOutput(
            metric_name="Expense", values=values, time_points=time_points
        )
