...
class DemandForecaster:
    def forecast(
        ...
        initial_demand = input_data.historical_data.get("demand", 0.0)
        values = growth_model.calculate_growth(
            initial_demand, input_data.time_horizon_months
        )
        time_points = [
        ...
        return ForecastOutput(
            metric_name="Demand", values=values, time_points=time_points
        )
